...
namespace timescale
{
	...
	public:
		...
		{
			dvars::override::register_float("timescale", 1.0f, 0.001f, 1000.0f, game::DVAR_FLAG_CHEAT | game::DVAR_FLAG_REPLICATED);
			dvars::override::register_float("com_timescale", 1.0f, 0.001f, 1000.0f, game::DVAR_FLAG_CHEAT | 0x40 | game::DVAR_FLAG_READ | game::DVAR_FLAG_REPLICATED);
