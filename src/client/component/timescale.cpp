...
namespace timescale
{
	...
	public:
		...
		{
			dvars::override::register_float("timescale", 1.0f, 0.1f, 1000.0f, game::DVAR_CHEAT);
			dvars::override::register_float("com_timescale", 1.0f, 0.1f, 1000.0f, game::DVAR_CHEAT | game::DVAR_SAVED | game::DVAR_INIT);
