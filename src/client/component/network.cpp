...
namespace network
{
	...
	public:
		void post_unpack() override
		{
			...
			dvars::override::register_int("cl_maxpackets", 1000, 1, 1000, game::DVAR_NOFLAG);

			// increase snaps
			dvars::override::register_int("sv_remote_client_snapshot_msec", 33, -1, 100, game::DVAR_NOFLAG);
