	...
	public:
		void post_unpack() override
		{
			scheduler::once([]()
			{
				...
				master_server_ip = game::Dvar_RegisterString("masterServerIP", "server.alterware.dev", game::DVAR_NOFLAG,
					"IP of the destination master server to connect to");
				master_server_port = game::Dvar_RegisterString("masterServerPort", "20810", game::DVAR_NOFLAG,
